...
public class BibliotecaABB implements Biblioteca {
	...
	private void ordenarPorPrecio() {
		Arbol arb = new ArbolBinarioBusqueda(comparaPrecio);
		ArrayList<MaterialCapacitacion> mats = (ArrayList)this.materiales();
		for(MaterialCapacitacion e : mats) {
			if(e!=null) {
				arb.add(e);
			}
		}
	...
	private void ordenarPorTitulo() {
		Arbol arb = new ArbolBinarioBusqueda(comparaTitulo);
		ArrayList<MaterialCapacitacion> mats = (ArrayList)this.materiales();
		for(MaterialCapacitacion e : mats) {
			if(e!=null) {
				arb.add(e);
